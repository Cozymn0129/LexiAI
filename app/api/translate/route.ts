...
export async function POST(req: Request) {
  try {
    ...
    const systemInstruction = `
      ...
      4. You must not output sentences in the same language as the input.(Japanese input should not produce Japanese output, and English input should not produce English output.)
